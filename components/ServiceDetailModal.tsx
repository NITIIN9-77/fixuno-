    ...
    return (
      <div key={subService.id} className="group flex items-center justify-between border border-slate-700/60 bg-slate-800/20 hover:border-primary transition-all p-6 rounded-2xl">
        <div className="flex-1 pr-6">
          ...
          {isPart && <p className="text-textSecondary text-[10px] uppercase tracking-[0.2em] mt-2 font-black opacity-60">Verified Component</p>}
        ...
        <div className="bg-surface rounded-[40px] shadow-[0_0_80px_rgba(0,0,0,0.6)] w-full max-w-2xl animate-scale-up-fade-in border border-slate-700 overflow-hidden flex flex-col max-h-[92vh]" onClick={(e) => e.stopPropagation()}>
          ...
          <header className="p-10 border-b border-slate-800 flex justify-between items-center bg-slate-900/40">
              <div>
                ...
                <p className="text-[10px] text-textSecondary uppercase tracking-[0.4em] mt-2 font-black opacity-60">Professional Service Labor Pricing</p>
              </div>
          ...
          <div className="flex-grow overflow-y-auto p-10 space-y-10 custom-scrollbar">
            <div className="space-y-5">
                <h3 className="text-xs font-black text-primary uppercase tracking-[0.4em] mb-8">Service Options</h3>
            ...
            {service.parts && service.parts.length > 0 && (
              <div className="space-y-5">
                <div className="flex items-center justify-between mb-8">
                    <h3 className="text-xs font-black text-textSecondary uppercase tracking-[0.4em]">Compatible Components</h3>
                    <span className="text-[9px] text-textSecondary/40 font-black uppercase tracking-widest bg-slate-800 px-3 py-1 rounded-full">Actual rates at visit</span>
                </div>
          ...
          {totalItems > 0 && (
            <footer className="p-10 border-t border-slate-800 bg-slate-900 shadow-[0_-20px_50px_rgba(0,0,0,0.5)] flex-shrink-0">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-[10px] text-textSecondary uppercase font-black tracking-widest mb-2 opacity-60">Total Labor Estimate</p>
