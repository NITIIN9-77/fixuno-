...
const MOCK_REVIEWS: ReviewItem[] = [
  { id: 1, name: "Rahul Sharma", rating: 5, text: "Excellent AC service! The technician was very professional and the jet cleaning made a huge difference in cooling.", date: "Oct 12, 2024", isVerified: true },
    ...
    <section className="py-24 bg-background animate-fade-in">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-black text-textPrimary uppercase tracking-tighter mb-6">Verified Reviews</h1>
            <p className="text-xl text-textSecondary max-w-2xl mx-auto">Stories from homeowners who trust FIXUNO for their daily service needs.</p>
        </div>
        ...
        <div className="mt-24 bg-surface/50 border border-slate-800 rounded-[40px] p-16 text-center max-w-4xl mx-auto shadow-inner relative overflow-hidden group">
            ...
            <p className="text-xl text-textSecondary mb-10 leading-relaxed max-w-2xl mx-auto">Help our community grow by sharing your honest feedback.</p>
