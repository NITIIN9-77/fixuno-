...
export const SERVICES: Service[] = [
  {
    ...
    parts: [
        { id: 'part-ac-pipe', name: 'Copper Pipe', price: 0 },
        { id: 'part-ac-remote', name: 'Universal Remote', price: 0 }
    ]
  },
  {
    id: 'lighting',
  ...
  },
  {
    ...
    description: 'Ceiling and exhaust fan installation, repair, and servicing.',
    icon: <FanIcon className="w-12 h-12 text-primary" />,
    subServices: [
        { id: 'fan-c-install', name: 'Ceiling Fan Installation', price: 199, description: 'Proper and safe installation of ceiling fans.' },
        { id: 'fan-c-repair', name: 'Ceiling Fan Repair', price: 249, description: 'Diagnosing noise or slow speed issues.' },
    ]
  },
  {
    id: 'large-appliance',
    ...
    description: 'Fixing refrigerators, washing machines, and major units.',
    icon: <ApplianceRepairIcon className="w-12 h-12 text-primary" />,
    subServices: [
        { id: 'app-fridge', name: 'Refrigerator Repair', price: 299, description: 'Visit and diagnosis of fridge issues.' },
        { id: 'app-wm', name: 'Washing Machine Repair', price: 299, description: 'Inspection charge for washing machine faults.' },
    ]
  },
  {
    id: 'wiring',
    ...
    subServices: [
        { id: 'wiring-point', name: 'New Wiring Point', price: 299, description: 'Creating new electrical points.' },
